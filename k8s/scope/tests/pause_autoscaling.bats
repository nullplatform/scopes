...
@test "pause_autoscaling: np_namespace strategy targets the namespace where the scope lives" {
  ...
  kubectl() {
    case "$*" in
      ...
      *"-n payments"*)
        case "$*" in
          "get hpa"*"-o json"*) echo '{"spec":{"minReplicas":2,"maxReplicas":10}}' ;;
          "get deployment"*) echo "5" ;;
        esac
        ;;
      *) return 1 ;;
    esac
